...
- [x] Тесты `diagnostics` и `self_test` на стороне Python.
...
- [ ] Индикатор статуса вне панели (чат / wand-меню).
- [ ] Баннер недоступности с одной кнопкой восстановления.

Проверено: 96 python-тестов, 9 JS-тестов, mypy, ruff, eslint — зелёные.
